...
export default async function AdminLoginPage() {
  ...
  return (
    <div className="min-h-screen bg-navy flex items-center justify-center px-4">
      <Card className="w-full max-w-md p-8 text-center bg-white shadow-xl rounded-2xl">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 text-sm mt-1">Inicia sesión con Google para continuar</p>
        </div>
        ...
        >
          <Button type="submit" className="w-full flex items-center justify-center gap-2 py-6 text-lg">
