    ...
    <div className="min-h-screen bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-[#1a365d] via-navy to-[#050b14] flex items-center justify-center p-4 sm:p-8">
      ...
      <div className="w-full max-w-[900px] bg-white rounded-[2rem] shadow-[0_20px_50px_rgba(0,0,0,0.5)] overflow-hidden flex flex-col md:flex-row relative animate-in fade-in slide-in-from-bottom-8 duration-1000">
        ...
        <div className="w-full md:w-[55%] p-10 sm:p-14 md:p-16 flex flex-col justify-center relative z-10 bg-white">
          ...
          {/* Decorative Email/Password Form (UI Only) */}
          <form className="space-y-5 mb-8 animate-in fade-in slide-in-from-right-4 duration-700 delay-300 fill-mode-both" action={async () => {
            "use server";
          }}>
            <div className="group relative">
              <div className="absolute inset-y-0 left-0 flex items-center pl-4 pointer-events-none text-gray-400 group-focus-within:text-gold transition-colors">
                <Mail className="w-5 h-5" />
              </div>
              <input
                type="email"
                placeholder="Correo electrónico"
                className="w-full pl-12 pr-4 py-4 bg-gray-50/50 border border-gray-200 rounded-2xl focus:bg-white focus:border-gold focus:ring-4 focus:ring-gold/10 focus:outline-none transition-all text-navy placeholder:text-gray-400 font-medium shadow-sm"
                required
              />
            </div>
            <div className="group relative">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-4">
              <button type="button" className="text-sm font-semibold text-gray-500 hover:text-gold transition-colors underline-offset-4 hover:underline">
                ¿Olvidaste tu contraseña?
              </button>
              <button 
                type="button" 
                className="w-full sm:w-auto px-8 py-3.5 bg-gradient-to-r from-gold to-[#c8843c] hover:from-[#c8843c] hover:to-[#b5722f] text-white rounded-xl font-bold tracking-wide shadow-lg shadow-gold/30 hover:shadow-xl hover:-translate-y-0.5 transition-all"
              >
                INGRESAR
              </button>
            </div>
          ...
          <div className="mt-6 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-500 fill-mode-both">
            <div className="flex items-center gap-4 mb-6">
              <div className="flex-1 h-[1px] bg-gradient-to-r from-transparent via-gray-200 to-transparent" />
              <span className="text-[11px] font-bold text-gray-400 tracking-[0.2em] uppercase">O ingresa de forma segura con</span>
              <div className="flex-1 h-[1px] bg-gradient-to-r from-transparent via-gray-200 to-transparent" />
            </div>
            ...
            >
              <button 
                type="submit" 
                className="w-full flex items-center justify-center gap-3 py-3.5 px-4 rounded-xl border-2 border-gray-100 bg-white hover:bg-gray-50 hover:border-gray-200 hover:shadow-md transition-all text-navy font-bold text-sm group"
              >
